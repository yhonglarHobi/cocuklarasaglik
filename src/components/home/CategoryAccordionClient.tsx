...
interface CategoryAccordionClientProps {
    categories: Category[];
    adsConfig: AdsConfig;
}

export function CategoryAccordionClient({ categories, adsConfig }: CategoryAccordionClientProps) {
